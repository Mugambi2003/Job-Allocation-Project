...
Route::middleware(['company:company'])->group(function() {
    ...
    Route::get('/company/photo', [CompanyController::class, 'photos'])->name('company_photos');
...
Route::middleware(['admin:admin'])->group(function(){
    ...
    Route::get('/admin/companies-job/{id}',[AdminCompanyController::class, 'companies_jobs'])->name('admin_companies_jobs');
    ...
    Route::get('/admin/companies-delete/{id}',[AdminCompanySizeController::class, 'delete'])->name('admin_companies_delete');
