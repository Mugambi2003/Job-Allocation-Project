            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 left-side">
                        <ul>
                            <li class="phone-text">0797118655</li>
                            <li class="email-text">mugambirintaugu@gmail.com</li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="item">
                            ...
                            <div class="list-item">
                                ...
                                <div class="right">mugambirintaugu@gmail.com</div>
                            </div>
                            <div class="list-item">
                                <div class="left">
                                    <i class="fas fa-envelope"></i>
                                </div>
                                <div class="right">0797118655</div>
                            </div>
                            <ul class="social">
                                <li>
                                    <a href=""
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="copyright">
                            Copyright 2023, Wera. All Rights Reserved.
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="right">
